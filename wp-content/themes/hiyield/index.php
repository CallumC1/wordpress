...
<body>
    ...
    <div class=" max-w-3xl mx-auto p-10">
        <h1 class="text-3xl font-semibold"><?= the_title(); ?></h1>
        <span class="flex gap-3 items-center text-teal-700 text-sm font-semibold text-wrap mb-2">
            <p class=""><?= the_author_meta('display_name', 1); ?></p>
    ...
    // Image attributes
    $size = null;
    $attr = ['class' => 'object-cover w-72 h-52 group-hover:scale-125 transiton-all duration-300'];
